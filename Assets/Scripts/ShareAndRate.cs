...
public class ShareAndRate : MonoBehaviour {
	...
	string subject = "Check out this awesome game";
	string body = "https://play.google.com/store/apps/details?id=com.snowflakes.biauidle";
	#if UNITY_IPHONE
	...
	{
		#if UNITY_ANDROID
		Application.OpenURL("https://play.google.com/store/apps/details?id=com.snowflakes.biauidle");
		#elif UNITY_IPHONE
